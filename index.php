    ...
    <header class="main-header">
        ...
        <nav class="main-nav" aria-label="Navigation principale du site">
            <ul>
                ...
                <li><a href="#modules" aria-label="Accéder à la section Modules">Modules</a></li> <li><a href="#gallery" aria-label="Accéder à la Galerie d'images">Galerie d'images</a></li>
    ...
    <main id="main-content">
        <div class="container">
            <section id="accueil" aria-labelledby="accueil-heading">
                ...
                <p>
                    VR-Rehab est une application de rééducation motrice en réalité virtuelle pensée pour les patient atteints d’hémiparésie. Elle s’appuie sur le principe de la thérapie miroir, qui consiste à refléter les mouvements de la main saine sur la main affectée pour stimuler la récupération. L’objectif est de rendre la rééducation plus motivante en combinant des exercices thérapeutiques et des éléments de jeu dans un environnement immersif.
                </p>
                <div class="stats-row">
                    <div class="stats-block">
                        <div class="stat-number">+50%</div>
                        <div class="stat-label">DES ENFANTS GARDENT DES SÉQUELLES MOTRICES DE LEURS AVC</div>
                    </div>
                    <div class="stats-block">
            ...
            <section id="présentation" aria-labelledby="presentation-heading">
                ...
                <div class="content-wrapper">
                    ...
                    <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/2VkO-Kc3vks?si=wJJVJ281UimYy3Rg"
                        title="Démonstration de VR-Rehab : Rééducation Motrice Gamifiée"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin"
                        allowfullscreen
                    ></iframe>
                    <p class="sr-only">Une transcription ou un résumé de la vidéo, incluant des informations détaillées sur le suivi des mouvements, est disponible sur <a href="https://www.meta.com/fr-fr/help/quest/290147772643252/?srsltid=AfmBOopPyZg3mbZ3QiEKquwEBBH2kNxO9hVDXd5uij7eh-bGtDpfDIN2" target="_blank" rel="noopener noreferrer">cette page d'aide de Meta Quest</a>.</p>
                </div>
            ...
            <section id="modules" aria-labelledby="modules-heading">
                <h2 id="modules-heading">Modules de l'application</h2>
                <p>Découvrez en détail les différents modules qui composent l'application VR-Rehab et leurs fonctionnalités.</p>
                <div class="gallery-grid">
                    <a href="module1_therapie_miroir.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 1 : Thérapie Miroir">
                        <img src="module1_therapie_miroir.png" alt="Image représentant le Module 1: Thérapie Miroir">
                        <div class="gallery-item-title">Module 1 : Thérapie Miroir</div>
                    </a>
                    <a href="module2_detection_gestes.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 2 : Détection des Gestes">
                        <img src="module2_detection_gestes.png" alt="Image représentant le Module 2: Détection des Gestes">
                        <div class="gallery-item-title">Module 2 : Détection des Gestes</div>
                    </a>
                    <a href="module3_adaptation_difficulte.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 3 : Adaptation de la Difficulté">
                        <img src="module3_adaptation_difficulte.png" alt="Image représentant le Module 3: Adaptation de la Difficulté">
                        <div class="gallery-item-title">Module 3 : Adaptation de la Difficulté</div>
                    </a>
                    <a href="module4_enregistrement_analyse_donnees.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 4 : Enregistrement et Analyse des Données">
                        <img src="module4_enregistrement_analyse_donnees.png" alt="Image représentant le Module 4: Enregistrement et Analyse des Données">
                        <div class="gallery-item-title">Module 4 : Enregistrement et Analyse des Données</div>
                    </a>
                    <a href="module5_box_block_test.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 5 : Box Block Test">
                        <img src="module5_box_block_test.png" alt="Image représentant le Module 5: Box Block Test">
                        <div class="gallery-item-title">Module 5 : Box Block Test</div>
                    </a>
                    <a href="module6_range_of_motion.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 6 : Range of Motion">
                        <img src="module6_range_of_motion.png" alt="Image représentant le Module 6: Range of Motion">
                        <div class="gallery-item-title">Module 6 : Range of Motion</div>
                    </a>
                    <a href="module7_speed_maintien_test.html" class="gallery-item" tabindex="0" role="button" aria-label="Accéder au Module 7 : speed et maitien">
                        <img src="module7_speed_maintien_test.png" alt="Image représentant le Module 5: Box Block Test">
                        <div class="gallery-item-title">Module 7 : Speed Test et Maintien Test</div>
                    </a>
                </div>
            </section>
    ...
    <script>
        ...
        (function() {
            ...
            clickableItems.forEach(item => {
                // Check if the item is part of the main gallery (not the new module links)
                // This prevents the module links from opening in the modal
                if (!item.closest('#modules')) { // Keep this check to prevent module links from opening the modal
